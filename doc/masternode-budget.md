...
Btcgreen now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month. 
...
mnbudget prepare proposal-name url payment_count block_start btcgreen_address monthly_payment_btcgreen [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ BTCGreen, _12_ times over the course of a year totaling _24000_ BTCGreen. 
...
When block ```1000000``` is reached you'll receive a payment for ```1200``` BTCGreen. 

The following new RPC commands are supported:
- mnbudget "command"... ( "passphrase" )
 - prepare            - Prepare proposal for network by signing and creating tx
 - submit             - Submit proposal for network
 - vote-many          - Vote on a Btcgreen initiative
 - vote-alias         - Vote on a Btcgreen initiative
 - vote               - Vote on a Btcgreen initiative/budget
