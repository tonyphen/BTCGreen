...
Only requiring some minor changes is btcgreen.cpp.
...
Changes to btcgreen.cpp
----------------------
btcgreen.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
