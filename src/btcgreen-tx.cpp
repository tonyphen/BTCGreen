...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Btcgreen Core btcgreen-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  btcgreen-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded btcgreen transaction") + "\n" +
              "  btcgreen-tx [options] -create [commands]   " + _("Create hex-encoded btcgreen transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded btcgreen transaction
