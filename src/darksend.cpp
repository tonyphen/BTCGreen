...
/* *** BEGIN DARKSEND MAGIC - BTCGreen **********
    Copyright (c) 2014-2015, Btcgreen Developers
        eduffield - evan@btcgreen.co
        udjinm6   - udjinm6@btcgreen.co
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Btcgreen and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("btcgreen-darksend");
