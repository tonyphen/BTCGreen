    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Btcgreen Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Btcgreen address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and btcgreen: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Btcgreen Core"), this);
    aboutAction->setStatusTip(tr("Show information about Btcgreen Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Btcgreen"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Btcgreen addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Btcgreen addresses"));
    ...
    openAction->setStatusTip(tr("Open a btcgreen: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Btcgreen Core help message to get a list with possible Btcgreen command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Btcgreen Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Btcgreen network", "", count));
}
...
{
    QString strTitle = tr("Btcgreen Core"); // default title
