    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Btcgreen Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Btcgreen Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  btcgreen-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Btcgreen Core is shutting down...") + "<br /><br />" +
