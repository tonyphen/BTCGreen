...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false))
    {
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Btcgreen Core"),
     ...
     * override -datadir in the btcgreen.conf file in the default data directory
     * (to be consistent with btcgreend behavior)
     */
    if(dataDir != getDefaultDataDirectory())
